                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li class="active"><a href=<?=base_url('index.html')?>>Dashboard 1</a></li>
                                    <li><a href="<?=base_url('dashboard_2.html')?>">Dashboard 2</a></li>
                                    <li><a href="<?=base_url('dashboard_3.html')?>">Dashboard 3</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                <li><a href="<?=base_url('ui-buttons.html')?>">Buttons</a></li>
                                    <li><a href="<?=base_url('ui-panels.html')?>">Panels</a></li>
                                    <li><a href="<?=base_url('ui-portlets.html')?>">Portlets</a></li>
                                    <li><a href="<?=base_url('ui-checkbox-radio.html')?>">Checkboxs-Radios</a></li>
                                    <li><a href="<?=base_url('ui-tabs.html')?>">Tabs</a></li>
                                    <li><a href="<?=base_url('ui-modals.html')?>">Modals</a></li>
                                    <li><a href="<?=base_url('ui-progressbars.html')?>">Progress Bars</a></li>
                                    <li><a href="<?=base_url('ui-notification.html')?>">Notification</a></li>
                                    <li><a href="<?=base_url('ui-images.html')?>">Images</a></li>
                                    <li><a href="<?=base_url('ui-carousel.html')?>">Carousel</a>
                                    <li><a href="<?=base_url('ui-bootstrap.html')?>">Bootstrap UI</a></li>
                                    <li><a href="<?=base_url('ui-typography.html')?>">Typography</a></li>
                                </ul>
                            </li>
