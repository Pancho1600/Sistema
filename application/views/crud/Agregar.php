   ...
   <!--HEAD-->
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="col-lg-6">
				<div class="card-box">
					<h4 class="m-t-0 header-title"><b>AGREGAR PRODUCTO</b></h4>
					...
					<form action="" data-parsley-validate="" novalidate="" method="post">
                        <div class="form-group">
							<label>Nombre*</label>
                            <input type="text" name="nombre1" parsley-trigger="change" required="" placeholder="Ingresa nombre" class="form-control" data-parsley-id="4">
                            <label class="danger"><?=form_error('nombre1')?></label>
						</div>
                        <div class="form-group">
							<label>Cantidad*</label>
							<input type="text" name="cantidad1" parsley-trigger="change" required="" placeholder="Ingresa cantidad" class="form-control" data-parsley-id="4">
                        ...
                        <div class="form-group">
                            ...
                            <label class="danger"><?=form_error('AMaterno1')?></label>
                        </div>
